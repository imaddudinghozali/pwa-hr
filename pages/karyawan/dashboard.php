...
<div class="dash-hero">
    <div class="dash-panel">
        <div style="display:flex;align-items:center;gap:16px;flex-wrap:wrap">
            ...
            <div style="flex:1;min-width:200px">
                <div class="dash-eyebrow">Beranda karyawan</div>
                <div class="dash-heading"><?=htmlspecialchars($user['nama'])?></div>
                <div class="dash-sub"><?=htmlspecialchars($user['jabatan_nama']??'-')?> &middot; <?=htmlspecialchars($user['dept_nama']??'-')?></div>
    ...
    <div class="dash-panel">
        ...
        <div class="quick-action-grid mt-1">
            <a class="quick-action" href="<?=BASE_URL?>/pages/karyawan/absensi.php"><span class="quick-action-icon">&#9673;</span><span>Absensi</span></a>
            <a class="quick-action" href="<?=BASE_URL?>/pages/karyawan/lembur.php"><span class="quick-action-icon">&#9201;</span><span>Lembur</span></a>
            <a class="quick-action" href="<?=BASE_URL?>/pages/karyawan/cuti.php"><span class="quick-action-icon">&#9675;</span><span>Cuti</span></a>
            <a class="quick-action" href="<?=BASE_URL?>/pages/karyawan/slip_gaji.php"><span class="quick-action-icon">Rp</span><span>Slip Gaji</span></a>
        </div>
    </div>
</div>
    ...
    <div class="card-body" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px">
        <div>
            ...
            <div class="text-sm" style="color:var(--text-2)">
                ...
                &nbsp;&middot; Keluar: <strong class="text-amber mono"><?=date('H:i',strtotime($absenHari['jam_keluar']))?></strong>
                <?php endif; ?>
                &nbsp;
...
<div class="stat-grid mb-2">
    ...
    <div class="stat-card green"><div class="stat-icon">Rp</div><div class="stat-label">Gaji Terakhir</div><div class="stat-value" style="font-size:14px"><?=$slip?formatRp($slip['gaji_bersih']):'-'?></div><div class="stat-sub"><?=$slip?bulanNama($slip['bulan']).' '.$slip['tahun']:'belum ada'?></div></div>
</div>
...
<div class="grid-2">
    <div class="card">
        ...
        <div class="tbl-wrap"><table>
            ...
            <tr><td colspan="4" class="empty-state">Belum ada absensi</td></tr>
    ...
    <div class="card">
        ...
        <div class="card-body quick-action-grid">
            <a href="<?=BASE_URL?>/pages/karyawan/absensi.php" class="quick-action"><span class="quick-action-icon">&#9673;</span><span>Absensi GPS</span></a>
            <a href="<?=BASE_URL?>/pages/karyawan/lembur.php" class="quick-action"><span class="quick-action-icon">&#9201;</span><span>Ajukan Lembur</span><?php if ($lemPend>0): ?><span class="badge badge-amber"><?=$lemPend?></span><?php endif; ?></a>
            <a href="<?=BASE_URL?>/pages/karyawan/cuti.php" class="quick-action"><span class="quick-action-icon">&#9675;</span><span>Pengajuan Cuti</span><?php if ($cutPend>0): ?><span class="badge badge-amber"><?=$cutPend?></span><?php endif; ?></a>
            <a href="<?=BASE_URL?>/pages/karyawan/slip_gaji.php" class="quick-action"><span class="quick-action-icon">Rp</span><span>Slip Gaji Saya</span></a>
            <a href="<?=BASE_URL?>/pages/karyawan/profil.php" class="quick-action"><span class="quick-action-icon">&#9679;</span><span>Profil & Password</span></a>
        </div>
    </div>
</div>
