...
CREATE TABLE users (
    ...
    jenis_karyawan ENUM('tetap','kontrak','magang') DEFAULT 'tetap',
    foto VARCHAR(255),
    alamat TEXT,
    telepon VARCHAR(20),
    ...
    gaji_pokok_override DECIMAL(15,2) DEFAULT NULL,
    tunjangan_jabatan_override DECIMAL(15,2) DEFAULT NULL,
